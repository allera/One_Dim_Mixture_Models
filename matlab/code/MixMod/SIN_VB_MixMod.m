...
if ~isfield(mix1.opts,'shift'), shift=0 ; 
else shift = mix1.opts.shift; end
%---SET DEFAULT OPTIONS
...
if ~isfield(src.opts,'shift'), shift=0 ; 
else shift = src.opts.shift; end

if shift~=0
    pos_shift=find(data<shift);
    neg_shift=find(data>-shift);
