...
if generate_new_data==1:
    from generate_data_vector2 import generate_data_vector_gammas
    data_vector=generate_data_vector_gammas(N_comps=2, N_samples=5000 ,means=[2. ,5.], variances= [2.,2.], mixing=[0.5, 0.5])
else:
